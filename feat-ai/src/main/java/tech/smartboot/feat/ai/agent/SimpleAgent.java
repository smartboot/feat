...
public class SimpleAgent extends AbstractAgent {
    ...
    public SimpleAgent(String name, ChatModel chatModel) {
        super(name, chatModel, new DefaultAgentMemory());
    }
    
    public SimpleAgent(String name, ChatModel chatModel, AgentMemory memory) {
