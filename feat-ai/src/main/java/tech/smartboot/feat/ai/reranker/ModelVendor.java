...
public class ModelVendor {
    ...
    public interface Gitee {
         ...
         */
        ModelVendor Qwen3_Reranker_8B = new ModelVendor(ChatOptions.AI_VENDOR_GITEE, "Qwen3-Reranker-8B");
        /**
         * Qwen3‑Reranker‑4B 是Qwen团队推出的一款基于大型（≈40亿参数）Decoder-only Transformer，专为跨语言和多域的信息检索排序任务优化的高性能reranker模型。
         */
        ModelVendor Qwen3_Reranker_4B = new ModelVendor(ChatOptions.AI_VENDOR_GITEE, "Qwen3-Reranker-4B");

        /**
         * Qwen3-Reranker-0.6B 是由 Qwen 团队开发的一款轻量级重排序模型，基于 transformer 架构，专为信息检索任务中的文档或答案排序优化而设计。
         */
        ModelVendor Qwen3_Reranker_06B = new ModelVendor(ChatOptions.AI_VENDOR_GITEE, "Qwen3-Reranker-0.6B");
    }
}
