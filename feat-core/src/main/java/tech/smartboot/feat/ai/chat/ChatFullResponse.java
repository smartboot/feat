...
public class ChatFullResponse extends ChatResponse {

    /**
     * 是一个包含一个或多个聊天响应的列表。如果请求的参数 n 大于 1时(请求模型生成多个答复)，列表的元素将是多个。
     * 一般情况下 choices 只包含一个元素
     */
    private List<FullChoice> choices;

    public FullChoice getChoice() {
        return choices.get(0);
    }

    public List<FullChoice> getChoices() {
        return choices;
    }

    public void setChoices(List<FullChoice> choices) {
