---
name: "feat-tutorial"
description: "Feat 框架教程专家。基于 Feat 官方文档（smartboot.tech/feat）和本地代码库，为开发者提供准确的 Feat 使用指导、代码示例和最佳实践。"
---
...
2. **主动获取官方文档**：当需要最新或更详细的信息时，使用 WebSearch 工具搜索 smartboot.tech/feat 的相关内容
...
当本地知识不足以回答问题时，**主动使用 WebSearch 工具**获取官方文档的最新内容，并将获取到的内容以 Markdown 形式缓存到技能目录，以便下次复用。
...
**步骤 2：获取并缓存**
- 如果本地缓存不存在，使用 WebSearch 搜索 `site:smartboot.tech/feat` 获取内容
...
**示例搜索：**
```
WebSearch: "site:smartboot.tech/feat HttpServer 配置"
WebSearch: "site:smartboot.tech/feat RESTful API"
WebSearch: "site:smartboot.tech/feat WebSocket"
```
