...
文档中的导航（如"上一篇"、"下一步"）应由系统根据 `_meta.json` 自动生成，避免文章更新时链接失效。

**禁止的硬编码导航**：
```mdx
❌ "上一篇：[快速入门](/docs/getstart/)"
❌ "下一篇：[路由配置](/docs/router/)"
❌ "学习路径位置：第 2 篇，共 8 篇"
❌ "## 下一步" 章节
```
...
**允许的文档引用**：
```mdx
✅ "参见 [路由配置](/docs/router) 了解详情"
✅ "关于依赖注入，详见 [DI 指南](/docs/di)"
✅ "如果你还不熟悉 Feat Cloud，建议先阅读 [快速入门](/docs/getstart)"
```
