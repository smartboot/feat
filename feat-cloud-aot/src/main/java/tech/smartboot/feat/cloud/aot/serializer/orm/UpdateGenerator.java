...
/**
 * 生成 @Update 方法的 JDBC 实现。
 */
public final class UpdateGenerator {
    private UpdateGenerator() {
    }

    public static void generate(PrintWriter printWriter, ExecutableElement method, Update update) {
        generate(printWriter, method, update.value());
    }
