...
public class SseClientAdvancedDemo {
    ...
    private static void resumeConnection(String lastEventId) throws Exception {
        ...
        SseClient client = Feat.sse("http://example.com/events", opt -> opt.lastEventId(lastEventId));
    ...
    static class EventStatistics {
        ...
        public void printStatistics() {
            ...
            System.out.println("[统计] 事件总数: " + totalEvents.get() + ", 错误数: " + errorCount.get() + ", 运行时间: " + uptime + "ms" + ", 事件频率: " + String.format("%.2f", eventsPerSecond) + " events/sec");
        }
