---
title: 版本历史
description: 记录 Feat 的版本演进、升级提示和兼容性变化
sidebar:
    order: 3
---
## v2.0.0 (2026-04-07)
...
**开源协议升级：AGPL → Apache 2.0**

这是 Feat 项目的一个重要里程碑。我们将开源协议从 AGPL 升级至 Apache 2.0，为企业和开发者提供更加友好的商业使用环境。

**为什么切换协议？**

Feat 项目自 2024 年 12 月启动以来，经历了快速的发展和迭代。在项目初期，我们选择 AGPL 协议旨在保护开源项目的完整性。然而，随着项目日益成熟，我们深刻认识到 AGPL 协议的"传染性"条款对企业用户构成了显著的法律风险，成为阻碍 Feat 广泛采用的主要因素。

Apache 2.0 已成为企业级开源项目的事实标准。Spring Framework、Kubernetes、TensorFlow 等顶级项目均采用该协议，在保护创作者权益与促进生态繁荣之间取得了良好平衡。

**对企业用户的价值：**
- 商业友好：可自由用于商业闭源项目，无需担心代码开源义务
- 专利授权：明确的专利使用权，降低知识产权风险
- 技术选型：降低法务审批门槛，加速技术决策流程
- 生态参与：可自由定制和扩展，无需回馈代码

**战略意义：**
- 商业应用拓展：企业可放心将 Feat 应用于金融科技、电商平台、物联网、企业内部系统等场景
- 生态繁荣：吸引更多贡献者参与，促进第三方库、工具链、解决方案等生态组件的繁荣发展
- 长期规划：为后续的技术路线图实施扫清障碍
...
升级至 v2.0.0 后，项目自动适用 Apache 2.0 协议。企业用户可放心用于商业项目，无需担心开源义务。

---

发版详情：[https://mp.weixin.qq.com/s/uXmXC8QiNt848_3fKqD98w](https://mp.weixin.qq.com/s/uXmXC8QiNt848_3fKqD98w)
...
发版详情：[https://mp.weixin.qq.com/s/fi0EmKhN9GHbUtZ6FfK3LA](https://mp.weixin.qq.com/s/fi0EmKhN9GHbUtZ6FfK3LA)
